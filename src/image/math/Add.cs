...
public static class CVAdd
{
    ...
    public static CVImage Add<TV>(CVImage image, TV arg1, int channel) where TV : struct
    {
        CVImage outImage = CVImage.Create(image.Width, image.Height, image.DataFormat, image.ChannelFormats);
    ...
    public static CVImagePyramid Add<TV>(CVImagePyramid image, TV arg1) where TV : struct
    {
    ...
    public static CVImagePyramid Add<TV>(CVImagePyramid image, TV arg1, int channel) where TV : struct
    {
        CVImagePyramid outImage = new CVImagePyramid(image.Levels);
