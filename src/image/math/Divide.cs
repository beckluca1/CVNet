...
public static class CVDivide
{
    ...
    public static CVImagePyramid Divide<TV>(CVImagePyramid image, TV arg1) where TV : struct
    {
    ...
    /*public static CVImagePyramid Divide<TV>(CVImagePyramid image, TV arg1, int channel) where TV : struct
    {
        CVImagePyramid outImage = new CVImagePyramid(image.Levels);
